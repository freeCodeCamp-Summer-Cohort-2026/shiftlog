...
def test_conflicts_endpoint_returns_conflicting_shifts(
    client: TestClient, session: Session, worker_id: int
):
...
def test_conflicts_endpoint_returns_empty_list_when_no_conflicts(
